...
import annotations.PutOperation;
...
public class PutController extends HttpMethodController {
    ...
    void setupOperationMap() throws InvalidHandlerMethodException {
        Set<Method> operationHandlers = getOperationHandlers(PutOperation.class);
        operationsMap = new HashMap<>();
        for (Method operationHandler : operationHandlers) {
            String endpoint = operationHandler.getAnnotation(PutOperation.class).endpoint();
